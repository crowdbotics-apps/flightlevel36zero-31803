"""flightlevel36zero_31803 URL Configuration
...
admin.site.site_header = "Flightlevel36zero"
admin.site.site_title = "Flightlevel36zero Admin Portal"
admin.site.index_title = "Flightlevel36zero Admin"

# swagger
api_info = openapi.Info(
    title="Flightlevel36zero API",
    default_version="v1",
    description="API documentation for Flightlevel36zero App",
)
